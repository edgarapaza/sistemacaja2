...
public class frmRecibo extends javax.swing.JFrame {
  ...
  public void Decimal(){
    ...
    private void initComponents() {
        ...
        jButton3.setText("ANULAR RECIBO");
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 640, -1, -1));

        chkDNI.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        chkDNI.setText("DNI N°");
        chkDNI.setIconTextGap(10);
        chkDNI.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkDNIActionPerformed(evt);
            }
        });
        chkDNI.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                chkDNIKeyPressed(evt);
            }
        });
        getContentPane().add(chkDNI, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, -1, -1));
        ...
        getContentPane().add(txtNunDNI, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, 110, -1));
        ...
        getContentPane().add(codUsu, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 40, 50, 20));
    ...
    private void btnBuscarSolicitudActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarSolicitudActionPerformed
        ...
        if (numero <8){
            ...
            try{
                ...
                codUsu.setText(rs.getString("codUsu"));
            }catch(SQLException e){
    ...
    private void chkDNIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkDNIActionPerformed
    ...
    }//GEN-LAST:event_chkDNIActionPerformed

    private void chkDNIKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_chkDNIKeyPressed
      
     
    }//GEN-LAST:event_chkDNIKeyPressed
    ...
    private javax.swing.JLabel codUsu;
