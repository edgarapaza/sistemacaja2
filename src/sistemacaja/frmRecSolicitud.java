...
public class frmRecSolicitud extends javax.swing.JFrame {
        ...
        */
        ...
        {           
            ...
            try {
                ...
                Logger.getLogger(frmRecSolicitud.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRecSolicitud.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmRecSolicitud().setVisible(true);
            }
        });
    }
